% Function 'boxplot_' produces a boxplot_ for each column of an input matrix. 
%
% Usage:   S = boxplot_(X, method, olflag, notches, titleb)
%          S = boxplot_(X, method, olflag, notches)
%          S = boxplot_(X, method, olflag)
%          S = boxplot_(X, method)
%          S = boxplot_(X)
%
%    Input:
...
%       titleb   string containing title for boxplot_.  If not supplied, 
%                the default title is 'boxplot_'
%
%    Output:
...
%       column of X. A boxplot_ is displayed for each column 
...
% This function comes with absolutely no guarantees.
   ...
   function  S = boxplot_(x, method, olflag, notches, titleb)
...
if (notches ~= 1 & notches ~= 0)
    ...
    disp('See help boxplot_ for more details')
    return
end
